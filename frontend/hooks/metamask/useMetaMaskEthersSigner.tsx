...
export const MetaMaskEthersSignerProvider: React.FC<{ children: ReactNode; initialMockChains: Readonly<Record<number, string>>; }> = ({ children, initialMockChains }) => {
...
export function useMetaMaskEthersSigner() {
  ...
  if (!context) throw new Error("useMetaMaskEthersSigner must be used within a MetaMaskEthersSignerProvider");
  return context;
}
